...
Строка 2 (только если РЕАЛИСТИЧНО): УЗКИЙ или ШИРОКИЙ — масштаб цели.
  УЗКИЙ: одна конкретная задача, которую можно освоить за 1–3 сессии. Признаки: названо одно конкретное блюдо, одна техника, одна функция, один аккорд, одна песня.
    Примеры УЗКИЙ: «яйцо-пашот», «карбонара», «приготовить карбонару», «готовить карбонару», «сварить борщ», «f-strings в Python», «аккорд Am», «Группа крови на гитаре», «завязать галстук», «параллельная парковка».
  ...
  ⚠️ ВАЖНО: «готовить/приготовить/сварить/испечь [конкретное блюдо]» — всегда УЗКИЙ, даже если начинается с глагола.

...
Не добавляй пояснений, markdown-блоков, комментариев — только JSON-массив."""
    ...
    if submitted:
        if not goal.strip():
            ...
            BUDGET_INFO = {
                0:     "Бесплатный режим — трек будет составлен только из бесплатных ресурсов: YouTube, открытые курсы, документация.",
                2500:  "Базовый бюджет — доступны недорогие курсы на Stepik и подписки на обучающие платформы.",
                5000:  "Средний бюджет — большинство онлайн-курсов и интенсивов в РФ доступны.",
                10000: "Комфортный бюджет — широкий выбор курсов, интенсивы, менторские программы.",
            }

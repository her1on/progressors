...
2. АБСТРАКТНО — цель не содержит конкретного навыка или предметной области, по которой можно составить учебный план: "стать лучше", "быть успешным", "развиваться", "жить счастливо", "стать богатым". Назвать конкретную технологию или профессию — не абстрактно.
...
Если АБСТРАКТНО — на следующей строке одно предложение: какой конкретный навык или профессию стоит указать вместо этого.

...
Все 4 вопроса должны оценивать практический уровень пользователя:

— 2 вопроса о личной практике: что пользователь уже делал, создавал, тренировал или применял в этой теме. Варианты ответов — шкала от "никогда не пробовал" до "делаю регулярно на высоком уровне".

— 2 вопроса о понимании ключевых концепций этой темы. Варианты ответов — от "никогда не слышал" до "уверенно применяю на практике".

Не спрашивай о косвенном опыте: просмотре контента, посещении мероприятий, общении с сообществом — только о том, что пользователь сам делал или изучал.

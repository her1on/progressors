...
КАТЕГОРИИ:
1. РЕАЛИСТИЧНО — любой конкретный навык, технология, профессия или дисциплина, доступная через обучение.

2. АБСТРАКТНО — цель не содержит конкретного навыка. Два случая:
   а) Размытые цели без конкретики: "стать лучше", "быть успешным", "стать богатым", "развиваться".
   б) "Стать + предмет/инструмент/объект/вещество/животное" — когда после "стать" стоит НЕ профессия, а вещь или существо: "стать Python", "стать питоном", "стать гитарой", "стать маслом". Признак: предмет не является ролью человека.
   НЕ абстрактно: "стать поваром", "стать фотографом", "стать Python-разработчиком" — здесь роль человека.

...
4. НЕРЕАЛИСТИЧНО — два случая:
   ...
   б) "Стать [не-человеческая сущность]" — после "стать" стоит то, чем человек буквально не может стать: животное, предмет, вещество, инструмент, технология, язык программирования.
      Примеры: "стать питоном", "стать с++", "стать гитарой", "стать деревом", "стать Excel", "стать маслом".
      НЕ нереалистично: "стать поваром", "стать программистом", "стать Python-разработчиком", "стать музыкантом" — здесь после "стать" стоит профессия или роль человека.

## Формат ответа

Верни ТОЛЬКО одно слово: РЕАЛИСТИЧНО, АБСТРАКТНО, ИНСТИТУЦИОНАЛЬНЫЙ или НЕРЕАЛИСТИЧНО.
Если АБСТРАКТНО — на следующей строке подсказка: что именно стоит указать вместо этого. Пример: «Попробуй уточнить цель — например, стать колумнистом, научиться писать тексты или освоить журналистику.»
Если ИНСТИТУЦИОНАЛЬНЫЙ — на следующей строке: что конкретно требует эта профессия.
Если НЕРЕАЛИСТИЧНО — на следующей строке: если похоже на ошибку формулировки — предложи как переформулировать (пример: «Возможно, ты имел в виду Python-разработку? Попробуй написать: стать Python-разработчиком.»); если физически невозможно — объясни почему.
